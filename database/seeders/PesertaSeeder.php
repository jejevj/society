...
class PesertaSeeder extends Seeder
{
    ...
    {
        DB::table('app_user')->where('role_id', 4)->delete();
        ...
        // ── Registrasi ke event EVT-2025-001 ──────────────────────────────────
        // Status: A=Approved, R=Rejected, P=Pending (2 each)
        DB::table('t_event_registrasi')->insert([
            // APPROVED
            ['kode_registrasi'=>'REG-2025-0001','kode_event'=>'EVT-2025-001','nama_peserta'=>'Andi Pratama',   'email_peserta'=>'andi.pratama@example.com', 'instansi_peserta'=>'Universitas Padjadjaran','no_hp_peserta'=>'081234560001','status_registrasi'=>'A','catatan_registrasi'=>'Registrasi diterima, dokumen lengkap.','created_by_registrasi'=>'andi.pratama@example.com','created_at'=>$now,'updated_at'=>$now],
            ['kode_registrasi'=>'REG-2025-0002','kode_event'=>'EVT-2025-001','nama_peserta'=>'Budi Santoso',   'email_peserta'=>'budi.santoso@example.com', 'instansi_peserta'=>'LIPI',                  'no_hp_peserta'=>'081234560002','status_registrasi'=>'A','catatan_registrasi'=>'Registrasi diterima, peneliti aktif.','created_by_registrasi'=>'budi.santoso@example.com','created_at'=>$now,'updated_at'=>$now],
            // REJECTED
            ['kode_registrasi'=>'REG-2025-0003','kode_event'=>'EVT-2025-001','nama_peserta'=>'Citra Dewi',     'email_peserta'=>'citra.dewi@example.com',   'instansi_peserta'=>'UGM',                   'no_hp_peserta'=>'081234560003','status_registrasi'=>'R','catatan_registrasi'=>'Dokumen tidak lengkap, silakan submit ulang.','created_by_registrasi'=>'citra.dewi@example.com','created_at'=>$now,'updated_at'=>$now],
            ['kode_registrasi'=>'REG-2025-0004','kode_event'=>'EVT-2025-001','nama_peserta'=>'Dian Kurniawan', 'email_peserta'=>'dian.kurniawan@example.com','instansi_peserta'=>'ITS',                   'no_hp_peserta'=>'081234560004','status_registrasi'=>'R','catatan_registrasi'=>'Kuota event telah penuh untuk kategori ini.','created_by_registrasi'=>'dian.kurniawan@example.com','created_at'=>$now,'updated_at'=>$now],
            // PENDING
            ['kode_registrasi'=>'REG-2025-0005','kode_event'=>'EVT-2025-001','nama_peserta'=>'Eka Fitriani',   'email_peserta'=>'eka.fitriani@example.com', 'instansi_peserta'=>'Universitas Hasanuddin','no_hp_peserta'=>'081234560005','status_registrasi'=>'P','catatan_registrasi'=>null,'created_by_registrasi'=>'eka.fitriani@example.com','created_at'=>$now,'updated_at'=>$now],
            ['kode_registrasi'=>'REG-2025-0006','kode_event'=>'EVT-2025-001','nama_peserta'=>'Fajar Nugroho',  'email_peserta'=>'fajar.nugroho@example.com','instansi_peserta'=>'PT Teknologi Nusantara','no_hp_peserta'=>'081234560006','status_registrasi'=>'P','catatan_registrasi'=>null,'created_by_registrasi'=>'fajar.nugroho@example.com','created_at'=>$now,'updated_at'=>$now],
        ]);

        // ── Paper — hanya untuk peserta Approved (REG-2025-0001 & REG-2025-0002)
        DB::table('t_paper')->insert([
            // Andi Pratama — 2 paper
            [
                'kode_paper'        => 'PAP-2025-0001',
                'kode_registrasi'   => 'REG-2025-0001',
                'kode_event'        => 'EVT-2025-001',
