...
class ReffAksesMenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('reff_akses_menu')->insert([
            // Akses menu existing dari SQL file
            ...
            // Akses menu Event untuk Super Admin
            ['id_akses_menu' => 45, 'role_id' => 1, 'menu_id' => 27, 'permit_r' => 1, 'permit_c' => 1, 'permit_u' => 1, 'permit_d' => 1, 'created_at' => '2026-05-29 00:00:00', 'updated_at' => null],
            ['id_akses_menu' => 46, 'role_id' => 1, 'menu_id' => 28, 'permit_r' => 1, 'permit_c' => 1, 'permit_u' => 1, 'permit_d' => 1, 'created_at' => '2026-05-29 00:00:00', 'updated_at' => null],
        ]);
    }
}
