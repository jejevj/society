                        ...
                        <div id="file-section">
                            ...
                            <div class="col-md-12 mt-4">
                                <div id="form-wrapper" class="container">
                                    @include('admin-panel.data.edit-dataset-table-file')
                                    <hr>							
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    $('#btn-save-detail').on('click', function () {
		...
		let fileInput = document.getElementById('m_file2');
		...
		$.ajax({
			url: "{{ route('updateFileDetailDataset') }}",
			type: "POST",
			data: formData,
