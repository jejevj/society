          ...
          <div class="card card-flush">
            <div class="card-body">
              <form id="actForm" class="mb-4" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-md-12 alert alert-warning"><h4 class="text-center">Meta Data Dataset</h4></div>
                  <!-- Judul Field -->
                  ...
                  <div id="file-section">
                      <div class="col-md-12 alert alert-warning mt-4"><h4 class="text-center">File Dataset</h4></div>
                        ...
                        <div class="upload-form border p-3 mb-3 rounded position-relative">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-4 mt-3">
                              ...
                              <input type="file" class="form-control" name="file[]" accept=".xls,.xlsx,.csv,.odt">
                              <span class="fs-7 text-danger">*Ekstensi File: .xls,.xlsx,.csv,.odt</span>
                            </div>
...
<script>
  ...
  $('#btn-save').on('click', function (e) {
    ...
    $.ajax({
      url: "{{ route('addDataAction') }}",
      type: 'POST',
      data: formData,
      beforeSend: function () {
          Swal.fire({
          title: "Sedang diproses & cek virus...",
