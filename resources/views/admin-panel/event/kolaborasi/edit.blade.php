...
@include('admin-panel.layouts.header')
										...
										<div class="card-body">
                                            <div class="mb-4">
                                                <div class="d-flex justify-content-end">
                                                    <a class="btn btn-warning btn-sm" href="{{ route('kolaborasiEvent', $detail->event_kode_kolaborasi) }}">
											...
											<form id="actForm" class="mb-4" enctype="multipart/form-data">
												@csrf
                                                <input type="hidden" name="key" value="{{$detail->kode_kolaborasi}}">
												<div class="row">
													<div class="col-md-12">
														<label class="fs-4 opacity-75 mb-4">Name:</label>
														<input type="text" value="{{$detail->nama_kolaborasi}}" class="form-control py-4" name="nama" placeholder="Name" >
													</div>
													<div class="col-md-6 mt-4">
														<label class="fs-4 opacity-75 mb-4">Images:</label><br>
                                                        <img src="{{ url('storage/'.$detail->gambar_kolaborasi) }}" class="img-fluid rounded" alt="Preview" style="max-height:150px;">
                                                    ...
                                                    <div class="col-md-6 mt-4">
                                                        ...
                                                        <textarea rows="4" name="keterangan" class="form-control py-4" rows="3">{{$detail->keterangan_kolaborasi}}</textarea>
													</div>
												</div>
												<div class="row">													
		...
		<script>
			...
			$('#btn-save').on('click', function (e) {
				...
				$.ajax({
					url: "{{ route('editKolaborasiEventAction') }}",
					type: 'POST',
					data: formData,
					contentType: false,
					processData: false,
