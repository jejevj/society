								...
								<div id="kt_app_content" class="app-content">
									...
									<div class="card card-flush mt-4">
										<div class="card-header align-items-center py-5 gap-2 gap-md-5">
											<div class="card-title"> Package List
											</div>
											<?php if($cek_permit['c']){?>
											<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
												<a href="{{ route('tambahPaketEvent', $detail->kode_event) }}" class="btn btn-marron-submit"><i class="fa fa-plus text-white"></i> Add Package Event</a>
											</div>
											<?php }?>
			...
			$(document).ready(function () {
                $('#mainTable').DataTable({
                    ...
                    columns: [
						...
						{data: 'judul_paket', name: 'judul_paket'},
						{data: 'sub_judul_paket', name: 'sub_judul_paket'},
