									...
									<div class="card card-flush mt-4">
										<div class="card-header align-items-center py-5 gap-2 gap-md-5">
											...
											<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
												<a href="{{ route('tambahProgramEvent', $detail->kode_event) }}" class="btn btn-marron-submit"><i class="fa fa-plus text-white"></i> Add Program Event</a>
											</div>
											<?php }?>
		...
		<script>
			$(document).ready(function () {
                $('#mainTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('getTableProgramEvent') }}",
                        data: function (d) {
                            d.key = '{{$kode_event}}'
                        }
                    },
                    ...
                    columns: [
						...
						{data: 'hari_program', name: 'hari_program'},
						{data: 'tanggal_program', name: 'tanggal_program'},
