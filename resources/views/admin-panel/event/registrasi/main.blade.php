							...
							<div class="d-flex flex-column flex-row-fluid">
								<div class="d-flex align-items-center pt-1">
									@include('admin-panel.layouts._breadcrumb', ['items' => [
										...
										['label' => 'Registrasi Peserta', 'url' => null],
									]])
								</div>
									...
									<div class="card card-flush">
										<div class="card-body">
											<div class="row">
												...
												<div class="col-md-4">
													<label class="fs-6 fw-semibold mb-2">Nama Peserta</label>
													<input type="text" id="filter-nama" class="form-control" placeholder="Nama peserta...">
												</div>
												<div class="col-md-4">
									...
									<div class="card card-flush mt-4">
										<div class="card-header align-items-center py-5 gap-2 gap-md-5">
											<div class="card-title">
												<span class="fs-5 fw-bold">Daftar Registrasi Peserta</span>
											</div>
										</div>
											...
											<table id="mainTable" class="display table align-middle table-row-dashed fs-6 gy-5">
												<thead>
													<tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
														<th>No</th>
														<th class="min-w-120px">Nama Peserta</th>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="modalCatatanLabel">Catatan</h5>
					...
					<div class="modal-body">
						...
						<div class="mb-3">
							...
							<textarea id="modal-catatan" class="form-control" rows="3" placeholder="Tulis catatan..."></textarea>
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
						<button type="button" class="btn btn-marron-submit" id="btnSubmitStatus">Simpan</button>
					</div>
				</div>
			</div>
		</div>
		...
		<script>
			$(document).ready(function () {
				...
				$(document).on('click', '.btn-approve-registrasi', function () {
					...
					$('#modal-status').val('A');
					$('#modalCatatanLabel').text('Approve Registrasi');
					$('#modal-catatan').val('');
				...
				$(document).on('click', '.btn-reject-registrasi', function () {
					$('#modal-key').val($(this).data('id'));
					$('#modal-status').val('R');
					$('#modalCatatanLabel').text('Reject Registrasi');
					$('#modal-catatan').val('');
					$('#modalCatatan').modal('show');
				});
				...
				$(document).on('click', '.btn-delete-registrasi', function () {
					...
					Swal.fire({
						title: 'Confirm', text: 'Hapus registrasi ini beserta semua paper terkait?', icon: 'warning',
