									...
									<div class="card card-flush">
										<div class="card-body">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <a class="nav-link" id="tab2-tab" data-bs-toggle="tab" href="#tab2" role="tab" aria-controls="tab2" aria-selected="false">Slider Dashboard</a>
                                                </li>
                                            ...
                                            <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                                                @include('admin-panel.konten-web.general-setting.slider')
                                            </div>
