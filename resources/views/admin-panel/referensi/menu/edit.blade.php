									...
									<div class="card card-flush">
										<div class="card-body">
											<form id="actForm" class="mb-4">
												@csrf
												<input type="hidden" name="key" value="{{$id_menu}}">
												<div class="row">
													<div class="col-md-2 mt-4">
														<label class="fs-4 opacity-75 mb-4">Nama Menu:</label>
													</div>
													<div class="col-md-4 mt-4">
														<input type="text" name="nama" class="form-control py-4" value="{{ $detail->nama_menu}}" placeholder="Masukkan Menu">
													</div>
													<div class="col-md-2 mt-4">
														<label class="fs-4 opacity-75 mb-4">Kode Menu:</label>
													</div>
													<div class="col-md-4 mt-4">
														<input type="text" name="kode" class="form-control py-4" value="{{ $detail->kode_menu}}" placeholder="Masukkan Kode Menu">
													</div>
													<div class="col-md-2 mt-4">
														<label class="fs-4 opacity-75 mb-4">Icon Menu:</label>
													</div>
													<div class="col-md-4 mt-4">
														<input type="text" name="icon" class="form-control py-4" value="{{ $detail->icon_menu}}" placeholder="Masukkan Icon Menu">
													</div>
													<div class="col-md-2 mt-4">
														<label class="fs-4 opacity-75 mb-4">Urutan Menu:</label>
													</div>
													<div class="col-md-4 mt-4">
														<input type="text" name="urutan" class="form-control py-4 only-number" value="{{ $detail->urutan_menu}}" placeholder="Masukkan Urutan Menu">
													</div>
													<div class="col-md-2 mt-4">
													...
													<div class="col-md-4 mt-4">
														<select name="jenis" id="jenis_menu" class="form-control py-4">
															...
															@foreach($status_menu as $s)
																<option <?php if($detail->jenis_menu == $s->kode_status){ echo 'selected'; }?> value="{{ $s->kode_status }}">{{ $s->keterangan_status }}</option>
															@endforeach
														</select>
													</div>
													...
													<div class="col-md-4 mt-4 master-menu" style="display:none;">
														<select name="parent" class="form-control py-4">
															...
															@foreach($master_menu as $s)
																<option <?php if($detail->parent_menu == $s->id_menu){ echo 'selected'; }?> value="{{ $s->id_menu }}">{{ $s->nama_menu }}</option>
															@endforeach
														</select>
													</div>
													<div class="col-md-2 mt-4">
													...
													<div class="col-md-4 mt-4">
														<textarea name="deskripsi" class="form-control py-4">{{ $detail->deskripsi_menu }}</textarea>
													</div>
