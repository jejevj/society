											...
											<form id="actForm" class="mb-4" enctype="multipart/form-data">
												...
												<div class="row">
													<div class="col-md-6 mt-4">
														<label class="fs-4 opacity-75 mb-4">Tag Name:</label>
														<input type="text" class="form-control py-4" name="nama" placeholder="Tag Name" >
													</div>
													
													<div class="col-md-6 mt-4">
														<label class="fs-4 opacity-75 mb-4">Orders:</label>
														<input type="number" class="form-control py-4" name="urutan" placeholder="Orders" >
													</div>
