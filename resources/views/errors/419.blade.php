...
<body>
    <div class="error-container">
        ...
        <p class="error-message">
            Maaf, sesi Anda telah kedaluwarsa karena tidak ada aktivitas dalam waktu yang lama. 
            Silakan muat ulang halaman dan coba lagi.
        </p>
        <a href="javascript:window.location.reload()" class="btn-home">Muat Ulang Halaman</a>
    </div>
</body>
</html>
