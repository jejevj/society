...
<html lang="id">
	<head>
		...
		<meta property="og:title" content="Society Event - Science Bank" />
					...
					<div class="app-container container-xxl d-flex align-items-stretch justify-content-between"
						...
						<div class="d-flex align-items-stretch justify-content-end flex-lg-grow-1" id="kt_app_header_wrapper">
							<div class="app-header-menu app-header-mobile-drawer align-items-stretch"
								...
								data-kt-drawer-width="350px" data-kt-drawer-direction="start"
									...
									<div class="menu-item me-0 me-lg-2">
										<a href="{{ route('about') }}" class="menu-link">
											<span class="menu-title fs-5">
												<span class="fw-bold {{ $menu_aktif == 'about' ? 'text-maroon-active' : 'text-white' }}">About</span>
											</span>
										</a>
									</div>
